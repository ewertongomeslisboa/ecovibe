...
export default function AboutPage() {
  ...
  const team = [
    {
      name: 'Ewerton Gomes Lisboa',
      role: 'Analista de Sistemas',
      description: 'Especialista em Desenvolvimento Web e IA aplicada à sustentabilidade',
    },
    {
      name: 'Michel Paulo Silva',
      role: 'Designer UX/UI',
      description: 'Focado em criar experiências intuitivas e acessíveis para todos os usuários',
    },
    {
      name: 'Antonio Joaquim Neres Junior',
      role: 'analista de Conteúdo',
      description: 'Desenvolve conteúdos  sobre meio ambiente',
    },
    {
      name: 'João Vitor Silva de Oliveira',
      role: 'debugador de Software',
      description: 'testador de software e garantia de qualidade',
    },
  ];
    ...
    <div className="min-h-screen bg-slate-50">
      <section className="bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl font-bold mb-6">Sobre o EcoVida</h1>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-gradient-to-br from-emerald-400 to-teal-500 rounded-2xl p-12 text-white">
            <h3 className="text-2xl font-bold mb-6">Por que o EcoVida?</h3>
